...
VOID SetupLights()
{
	...
	mtrl.Ambient.r = 0.0f; //1.0f
	mtrl.Ambient.g = 0.0f; //0.0f
	mtrl.Ambient.b = 0.0f; //0.0f
	mtrl.Ambient.a = 1.0f; //1.0f

	mtrl.Diffuse.r = 100.0f; //1.0f
	mtrl.Diffuse.g = 0.0f; //1.0f
	mtrl.Diffuse.b = 0.0f; //0.0f
	mtrl.Diffuse.a = 0.0f; //1.0f
	...
	light.Diffuse.r = 0.0f;	//1.0f						/// 광원의 색깔과 밝기
	light.Diffuse.g = 100.0f; //1.0f
